...
- 2026-09-12 — Round 8 committed (`ded60ed`). Round 9 (§1 #44): bank-aware routing and spawn nodes, NPC stuck tracking, visit give-up timeouts (`events.visitApproachTimeoutSeconds/visitStuckSeconds/visitLeaveTimeoutSeconds`).
